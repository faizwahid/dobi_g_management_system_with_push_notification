...
<main class="form-signin">
  <form action="<?php echo URLROOT; ?>/staffs/login" method="POST">
    <h1 class="h3 mb-3 fw-normal">Please sign in | <p class="fw-lighter">staff</p></h1>
...
<script src="<?php echo URLROOT; ?>/js/rememberMeStaff.js"> </script>
