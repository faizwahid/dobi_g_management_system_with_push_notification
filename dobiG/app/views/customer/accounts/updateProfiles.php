            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card shadow-2-strong card-registration text-dark" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo URLROOT; ?>/customers/updateProfile" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-4">

                                    <span style="color:red ;"><?php echo $data['name_err']; ?></span>
                                    <div class="form-outline">
                                        <input type="text" id="name" name="name" class="form-control form-control-lg <?php if (!empty($data['name_err'])) echo 'is-invalid'; ?>" value="<?php echo $data['name']; ?>" />
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="form-outline">
                                        <input type="text" disabled id="username" name="username" class="form-control form-control-lg" value="<?php echo $data['username']; ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4 d-flex align-items-center">
                                    <div class="form-outline">
                                        <textarea name="address" class="form-control <?php if (!empty($data['address_err'])) echo 'is-invalid'; ?>" id="address" cols="30" rows="3" placeholder="Your Address"><?php echo $data['address']; ?></textarea>
                                    </div>
                                </div>
